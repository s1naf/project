...
- Navigate to the `Node` directory and create a `.env` file with the following content:
```sh
cd Node
```
...
- Navigate back to the root directory of the project and run the following command:
```sh
cd ..
